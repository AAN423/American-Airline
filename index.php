  ...
  <div class="login-wrap">
    <div class="login-panel">
      ...
      <?php if ($err === 'not_member'): ?>
        <div class="alert alert-error">Akun Discord kamu belum tergabung di server American Airlines PTFS. Join server dulu, lalu login lagi.</div>
      <?php elseif ($err === 'denied'): ?>
        <div class="alert alert-error">Login dibatalkan.</div>
      <?php elseif ($err === 'oauth_failed'): ?>
        <div class="alert alert-error">Login Discord gagal. Coba lagi.</div>
      <?php endif; ?>
      ...
      <p class="login-note">Kamu wajib menjadi member server Discord American Airlines PTFS untuk bisa masuk.</p>
    </div>
